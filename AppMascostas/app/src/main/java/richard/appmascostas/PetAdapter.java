...
public class PetAdapter extends RecyclerView.Adapter<PetAdapter.ViewHolder> {
    ...
    public PetAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        try{
             view = LayoutInflater.from(context).inflate(R.layout.pet_list_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            petOwnerTextView = (TextView) itemView.findViewById(R.id.pet_list_item_name_owner);
